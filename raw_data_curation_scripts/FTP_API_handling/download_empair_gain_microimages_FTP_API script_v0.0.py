...
ftp.login()    
data_path = f'/empiar/world_availability/{empiar_id}/data/job008/Raw_data'
ftp.cwd(data_path)
image_list = ftp.nlst()
cap = 0
for image in (image_list):
    ...
    if (tiff_extension == 'tiff' or mrc_extension == 'mrc') and (cap <10):
        ...
        download_url  = f'https://ftp.ebi.ac.uk/empiar/world_availability/{empiar_id}/data/job008/Raw_data/{image}'
        print(download_url)
